...
public class Trabalho implements Serializable{
    ...
    public void carregaArquivoDocentes(FileInputStream docentes) throws Exception{
        ...
        while(scanner.hasNext()){
            try{
                ...
                Excecoes.ErroDeCodigo.checa_se_existe(docente, this.docentes);
            ...
            catch(Excecoes.ErroDeCodigo exception){
                System.out.println(exception.getMessage());
                this.exit = 1;             
            }
            finally{
                if(this.exit == 1) break;
            }
    ...
    public void carregaArquivoPublicacoes(FileInputStream publicacoes) throws Exception{
        ...
        while(scanner.hasNext()){
            try{
                ...
                for(String autor:docentes_){
                    for(Docente docente:this.docentes){
                        Excecoes.ErroDeDocente.checa_se_existe(autor.trim(),this.docentes,titulo);
            ...
            catch(Excecoes.ErroDeDocente exception){
                System.out.println(exception.getMessage());
                this.exit = 1;
            }
